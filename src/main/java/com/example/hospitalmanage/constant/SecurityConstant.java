...
public final class SecurityConstant {
    ...
    public static final String GET_ARRAYS_ADMINISTRATION = "Portal hospital-teams";
    ...
    public static final String[] PUBLIC_URLS = { "/user/login", "/user/register", "/user/image/**", "/ws/**",  "/chat/**"};
